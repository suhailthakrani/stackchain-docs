...
![How stackchain works](/how-it-works.svg)
...
See [Smart merge](/guides/smart-merge/). Hand code outside `// <stackchain:…>` markers is preserved. Domain/data survive `migrate` presentation rewrites.
