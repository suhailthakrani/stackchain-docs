...
See [Smart merge](/stackchain-docs/guides/smart-merge/). Hand code outside `// <stackchain:…>` markers is preserved. Domain/data survive `migrate` presentation rewrites.
