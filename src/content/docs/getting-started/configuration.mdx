...
Controls feature folder layout. See [Architecture](/stackchain-docs/architecture/overview/).
...
Unknown architecture strings (for example `hexagonal`) throw a format error at parse time. Prefer values from this page or [stackchain.yaml reference](/stackchain-docs/reference/stackchain-yaml/).
