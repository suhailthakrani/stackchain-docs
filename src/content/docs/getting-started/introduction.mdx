...
Current package version: **1.1.3** · License: **MIT** · [pub.dev/packages/stackchain](https://pub.dev/packages/stackchain)
...
2. **Lifecycle-aware** — `init`, `feature`, `rename`, `remove`, `sync`, `upgrade`, and `migrate` cover the full project life.
