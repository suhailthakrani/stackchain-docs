...
Current package version: **1.1.1** · License: **MIT** · [pub.dev/packages/stackchain](https://pub.dev/packages/stackchain)
...
Continue with [Installation](/getting-started/installation/) or dive into [How it works](/guides/how-it-works/).
